...
// function infoFunc(name){
//     return 'My name is'+name;
// }
// console.log(infoFunc(" Nadir"));
...
// console.log(data.time(1999));

// const sayHi=(name)=>{
//     return `Hello, ${name}. How a u ?`; 
// }
// console.log(sayHi('Nadir'));


// const infoData = "JavaScript Hello";
// console.log(infoData.trim());
...
//         console.log('duyu');
//     }
//     return `Enter money:${pay}`;
// }
// console.log(shop(earn));
